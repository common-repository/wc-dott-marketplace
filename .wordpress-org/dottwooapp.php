...
<strong><div class="content"><?php the_content(); ?><a class="less-button" href="https://linkjob.site/dott_woo_feed_manager" target="_blank">Editar Feed Produtos</a></div></strong>
	...
	<ul class="ul-spaced">
      ...
      <ul class="ul-spaced"><p>
		...
		<strong><label for="dott_merchant_id">Vendor ID:</label></strong>
...
<p class="text-center">
			...
			Copyright &copy;<script>document.write(new Date().getFullYear());</script> Connector Dott for WooCommerce by <a href="https://www.teracondition.pt" target="_blank" title="teracondition.pt">TERA.condition.</a> Todos os direitos reservados | Made in Portugal</a>
			...
			<br>versão 1.1<a href="https://teracondition.pt/assets/dott_woo_releases/release_list.php" target="_blank" title="teracondition.pt"> | Releases</a>
